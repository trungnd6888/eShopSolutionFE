...
import CategoryTableHead from '../CategoryTableHead/CategoryTableHead';
import CategoryTableToolbar from '../CategoryTableToolbar/CategoryTableToolbar';
...
function CategoryTable({
    ...
    const rows = categoryList.map(category => createData(
        category.name,
        category.id,
    ));
    ...
    const handleControlOpen = async (event) => {
        ...
        try {
            ...
            console.log('Fail to fetch category by id', error);
        }
    };
    ...
    const handleAddOpen = (event) => {
        if (onAddOpenClick) onAddOpenClick(category);
    ...
    const handleAcceptRemove = () => {
        ...
        if (onRemoveClick) onRemoveClick(categoryId);
