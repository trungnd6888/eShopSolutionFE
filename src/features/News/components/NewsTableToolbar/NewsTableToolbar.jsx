...
import { Box, Button, Grid, TextField, Toolbar, Tooltip } from '@mui/material';
...
NewsTableToolbar.defaultValues = {
  onAddOpenClick: null,
  numberSelected: 0,
  onSubmit: null,
  onRemove: null,
...
function NewsTableToolbar({ numSelected, onSubmit, onAddOpenClick, onAccept }) {
...
export default NewsTableToolbar;
