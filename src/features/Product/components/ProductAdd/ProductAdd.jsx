...
function ProductAdd({ onClose, onSubmit, open, categoryList, distributorList, product }) {
  ...
  const resetValues = {
    ...
    categories: isUpdate
      ? categoryList.filter((x) => product.categories.map((y) => y.id).includes(x.id))
      : [],
    distributors: isUpdate
      ? distributorList.filter((x) => product.distributors.includes(x.id))
      : [],
    thumbnailImages0: [],
    thumbnailImages1: [],
    thumbnailImages2: [],
              ...
              <Grid item xs={12} sm={12} md={12}>
                ...
                <Stack direction="row" sx={{ flexWrap: 'wrap' }}>
                  <CustomizeFileUpload
                    ...
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages0', 'inputHidden0');
                    }}
                  />
                  <CustomizeFileUpload
                    ...
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages1', 'inputHidden1');
                    }}
                  />
                  <CustomizeFileUpload
                    ...
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages2', 'inputHidden2');
                    }}
                  />
                  <CustomizeFileUpload
                    ...
                    title="Ảnh 3"
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages3', 'inputHidden3');
                    }}
                  ...
                  <CustomizeFileUpload
                    ...
                    title="Ảnh 4"
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages4', 'inputHidden4');
                    }}
                  ...
                  <CustomizeFileUpload
                    ...
                    title="Ảnh 5"
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages5', 'inputHidden5');
                    }}
                  ...
                  <CustomizeFileUpload
                    ...
                    title="Ảnh 6"
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages6', 'inputHidden6');
                    }}
                  ...
                  <CustomizeFileUpload
                    ...
                    title="Ảnh 7"
                    onClose={() => {
                      handleFileUploadClose('thumbnailImages7', 'inputHidden7');
                    }}
                ...
                <Controller
                  ...
                  render={({ field: { name, onChange, value } }) => (
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} variant="standard" label="Bộ sưu tập" />
                      )}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field: { name, onChange, value } }) => (
                    <Autocomplete
                      ...
                      filterSelectedOptions
                      renderInput={(params) => (
                        <TextField {...params} variant="standard" label="Nhà phân  phối" />
                      )}
                    />
                  )}
                />
